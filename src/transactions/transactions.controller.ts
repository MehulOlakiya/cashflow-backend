...
import { CreateTransactionsBulkDto } from './dto/create-transactions-bulk.dto';
...
export class TransactionsController {
   ...
   * Create a validated batch of transactions for an Excel income import.
   */
  @Post('bulk')
  @HttpCode(HttpStatus.CREATED)
  async createMany(
    @Request() req: any,
    @Body() dto: CreateTransactionsBulkDto,
  ) {
